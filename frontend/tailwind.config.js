  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        body: ["var(--font-poppins)", "ui-sans-serif", "system-ui"],
      },
      boxShadow: {
        card: "0 2px 8px -1px rgba(0, 0, 0, 0.05), 0 1px 2px -1px rgba(0, 0, 0, 0.03)",
        "card-hover":
        ...
        "elevation-4":
          "0 10px 15px rgba(0, 0, 0, 0.04), 0 4px 6px rgba(0, 0, 0, 0.08)",
      },
      spacing: {
        128: "32rem",
        144: "36rem",
      ...
      animation: {
        ...
        "slide-down": "slideInDown 0.5s ease-out forwards",
